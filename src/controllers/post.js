...
import { getPostsInRange, getDistanceInformationToPosts } from '../services/postsInRange'
...
export async function readAll(req, res) {
    ...
    const postsWithDistance = getDistanceInformationToPosts({ longitude, latitude }, rawPosts)
